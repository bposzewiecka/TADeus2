...
from .models import TrackFile, Assembly
from .tables import TrackFileFilter, TrackFileTable
from .readBed import ReadBedOrBedGraphException, BedOrBedGraphReader

from .forms import TrackFileForm
from django.db.models import Q

from tadeus_portal.utils import only_public_or_user
from django_tables2 import RequestConfig

from tadeus_portal.utils import set_owner_or_cookie, is_object_readonly
...
def update(request, p_id):
    ...
    return render(request, 'datasources/datasource.html', {'form': form,  
